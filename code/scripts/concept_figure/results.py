...
def plot_samples(
    ...
    plt.scatter(gt_samples[:, 0], gt_samples[:, 1], alpha=0.1, color='red')
    if method_name is not None and budget is not None and run_id is not None:
    ...
    if method_name is not None:
        ...
        fontweight = 'bold' if method_name in ["r2omc"] else 'normal'
        ...
        plt.text(
            ...
            fontsize=35, color='black', fontweight=fontweight,
