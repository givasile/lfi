...
\section{Discussion about simulation budget}
\ref{app-sec:compute-budget}
...
\begin{figure*}[!t]
  ...
  \label{fig:mog_benchmark_frontier}
\end{figure*}
...
\begin{figure}
    ...
    \includegraphics[width=.24\linewidth]{figures/mog_benchmark/single_mode/Flow Matching_c2st_heatmap}
...
\begin{figure}
    ...
    \includegraphics[width=.24\linewidth]{figures/mog_benchmark/single_mode_distractors/Flow Matching_c2st_heatmap}
...
\begin{figure}
    ...
    \includegraphics[width=.24\linewidth]{figures/mog_benchmark/two_modes/Flow Matching_c2st_heatmap}
...
\begin{figure}
    ...
    \includegraphics[width=.24\linewidth]{figures/mog_benchmark/two_modes_distractors/Flow Matching_c2st_heatmap}
...
\begin{figure}
    \centering
    \includegraphics[width=.49\linewidth]{figures/sbibm/slcp/c2st}
    \includegraphics[width=.49\linewidth]{figures/sbibm/slcp/runtime}
    \caption{T.3: SLCP. From left to right: \texttt{C2ST} vs. budget, and runtime vs. budget.}
    \label{fig:exp_sbi_slcp}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=.49\linewidth]{figures/sbibm/slcp_distractors/c2st}
    \includegraphics[width=.49\linewidth]{figures/sbibm/slcp_distractors/runtime}
    \caption{T.4: SLCP Distractors. From left to right: \texttt{C2ST} vs. budget, and runtime vs. budget.}
    \label{fig:exp_sbi_slcp_distractors}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=.49\linewidth]{./figures/sbibm/slcp/pairwise_posterior_obs_0}
    \includegraphics[width=.49\linewidth]{./figures/sbibm/slcp/pairwise_posterior_obs_1}\\
    \includegraphics[width=.49\linewidth]{./figures/sbibm/slcp/pairwise_posterior_obs_2}
    \includegraphics[width=.49\linewidth]{./figures/sbibm/slcp/pairwise_posterior_obs_2}    
    \caption{T.3: SLCP. From left to right: total samples, accepted samples, and selected samples by R2OMC.}
    \label{fig:exp_sbi_slcp_samples}
\end{figure}
