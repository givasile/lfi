...
%
Existing simulation-based inference methods often require large number of simulations and become inefficient in settings such as high-dimensional parameter spaces or with partially uninformative outputs.
%
...
%
A JAX-based implementation further enhances the performance through parallelization of key method components.
%
