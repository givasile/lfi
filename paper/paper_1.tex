...
\begin{figure*}[!ht]
  \centering
  \includegraphics[width=\linewidth]{figures/old/concept_image}
  \caption{
...
%   % \end{subfigure}
%   \caption{C2ST Success Frontier ($\leq 0.75$)}
...
\subsubsection{SLCP and SLCP with distractors}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.32\linewidth}
        ...
        \label{subfig:sbi_two_moons_total}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
    ...
    \begin{subfigure}[b]{0.32\linewidth}
        ...
        \label{subfig:sbi_two_moons_selected}
    \end{subfigure}
    \caption{2-moons pairwise posteriors}
    \label{fig:sbi_experiments_two_moons_posteriors}
\end{figure*}
...
\subsubsection{Lotka-Voltera model}

\begin{figure*}
  \centering
  \includegraphics[width=0.7\linewidth]{./figures/sbibm/lotka_volterra/posterior_pairwise.png}
