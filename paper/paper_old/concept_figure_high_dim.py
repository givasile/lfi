...
# Plot ground truth
utils.plot_gt_2d(savefig="paper/figures/concept_image_highdim_gt.pdf")
...
utils.plot_posterior_kde_2D(samples_romc, savefig="paper/figures/concept_image_highdim_romc_kde.pdf", bw_method=.2)
...
utils.plot_posterior_kde_2D(samples_rromc, savefig="paper/figures/concept_image_highdim_rromc_kde.pdf", bw_method=.2)
...
utils.plot_posterior_kde_2D(samples_nle, "paper/figures/concept_image_highdim_nle_kde.pdf", bw_method=.2)
...
for _ in range(nof_epochs):
    ...
    # x = simulator(theta)
    _ = inferer.append_simulations(torch.Tensor(theta), torch.Tensor(x), proposal=proposal).train(training_batch_size=tr_batch_size, max_num_epochs=300)
...
utils.plot_posterior_kde_2D(samples_npe, savefig="paper/figures/concept_image_highdim_npe_kde.pdf", bw_method=0.2)
...
utils.plot_posterior_kde_1d(
    ...
    samples_npe,
    samples_nle,
    savefig="paper/figures/concept_image_highdim.pdf"
)
