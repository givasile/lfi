...
# Plot ground truth
utils.plot_gt_2d("paper/figures/concept_image_multiple_gt.pdf", 4)
...
utils.plot_posterior_kde_2D(samples_romc, "paper/figures/concept_image_multiple_romc_kde.pdf")
...
config = {
    ...
    "nof_samples": 2_000,
    "eps_3": .5,
    "nof_samples_to_select": 5_000,
}
tic = time.time()
samples_rromc = rromc.infer(config)
toc = time.time() - tic
print(f"R2OMC took {toc} seconds.")
utils.plot_posterior_kde_2D(samples_rromc, savefig="paper/figures/concept_image_multiple_rromc_kde.pdf")
...
utils.plot_posterior_kde_2D(samples_nle, "paper/figures/concept_image_multiple_nle_kde.pdf")
...
utils.plot_posterior_kde_2D(samples_npe, "paper/figures/concept_image_multiple_npe_kde.pdf", bw_method=0.3)
...
utils.plot_posterior_kde_1d(
    ...
    samples_npe,
    samples_nle,
    savefig="paper/figures/concept_image_multiple.pdf"
)
