...
\paragraph{FMPE.} As FMPE, i.e., Flow Matching Posterior Estimation, we refer to the method proposed by~\cite{wildberger2023flow}. 

We use the implementation provided by \href{https://sbi-dev.github.io/sbi/latest/reference/inference/#sbi.inference.trainers.fmpe.fmpe.FMPE}{SBI}, 
with a a two-layer neural network as denstity estimator (\texttt{density\_estimator = `mlp'}) and its default training parameters. 
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    ylabel={Min. Simulation Budget},
    ymode=log,
    xmin=2, xmax=10,
    ymin=100, ymax=100000,
    xtick={2,4,6,8,10},
    ytick={100,1000,10000,100000},
    title={Accuracy Frontier (C2ST < 0.65)},
    legend style={at={(0.5,-0.25)}, anchor=north, legend columns=3},
    grid=both,
    every axis plot/.append style={thick}
  ]

  % Reusing fake budget data
  ...
  \end{axis}
\end{tikzpicture}
\caption{Simulation budget required to reach C2ST < 0.65}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.45\textwidth}
\begin{tikzpicture}
  \begin{axis}[
    ...
    title={Runtime Frontier (C2ST < 0.65)},
    grid=both,
    every axis plot/.append style={thick}
  ]
  ...
  \end{axis}
\end{tikzpicture}
\caption{Corresponding runtime for same performance frontier}
\end{subfigure}
\caption{Comparison of simulation-based inference methods. Left: Budget needed to reach C2ST < 0.65. Right: Corresponding runtime required. Lower is better.}
\end{figure}
...
\begin{figure}[]
  \centering
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_3_gt_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_3_npe_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_3_nle_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_3_romc_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_3_r2omc_samples.pdf}\\
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_5_gt_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_5_npe_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_5_nle_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_5_romc_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_5_r2omc_samples.pdf}\\
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_10_gt_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_10_npe_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_10_nle_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_10_romc_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_10_r2omc_samples.pdf}\\
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_20_gt_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_20_npe_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_20_nle_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_20_romc_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_base_N_20_r2omc_samples.pdf}
...
\begin{figure}[]
  \centering
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_2_gt_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_2_npe_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_2_nle_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_2_romc_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_2_r2omc_samples.pdf}\\
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_5_gt_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_5_npe_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_5_nle_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_5_romc_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_5_r2omc_samples.pdf}\\
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_10_gt_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_10_npe_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_10_nle_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_10_romc_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_10_r2omc_samples.pdf}\\
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_20_gt_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_20_npe_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_20_nle_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_20_romc_samples.pdf}
  \includegraphics[width=0.19\linewidth]{./figures/exp_multi_observation_MoG_N_20_r2omc_samples.pdf}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.32\linewidth}
    \centering
    \includegraphics[width=\linewidth]{./figures/exp_sbi_gaussian_mixture_gt.pdf}
    \caption{Ground truth samples}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.32\linewidth}
    \centering
    \includegraphics[width=\linewidth]{./figures/exp_sbi_gaussian_mixture_r2omc.pdf}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.32\linewidth}
    \centering
    \includegraphics[width=\linewidth]{./figures/exp_sbi_two_moons_gt.pdf}
    \caption{Ground truth samples}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.32\linewidth}
    \centering
    \includegraphics[width=\linewidth]{./figures/exp_sbi_two_moons_r2omc.pdf}
    \caption{Samples by R2OMC}
  \end{subfigure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.23\linewidth]{./figures/multi_obs_case_1_iterative_romc.pdf}
    \includegraphics[width=0.23\linewidth]{./figures/multi_obs_case_1_romc.pdf}
    \includegraphics[width=0.23\linewidth]{./figures/multi_obs_case_2_iterative_romc.pdf}
    \includegraphics[width=0.23\linewidth]{./figures/multi_obs_case_2_romc.pdf}
