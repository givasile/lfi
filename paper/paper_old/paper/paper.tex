...
\begin{figure}
  ...
  %   \caption{\texttt{2-moons}: R2OMC}
  %   \label{subfig:sbi_two_moons_r2omc_samples}
  % \end{subfigure}
  % \begin{subfigure}[b]{.49\linewidth}
  %   \centering
  %   \includegraphics[width=\linewidth]{./figures/exp_sbi_gaussian_mixture_r2omc.pdf}
  %   \caption{\texttt{MoG}: R2OMC}
  %   \label{subfig:sbi_gaussian_mixture_r2omc_samples}
  % \end{subfigure}\\
  % \begin{subfigure}[b]{.49\linewidth}
  %   \centering
  %   \includegraphics[width=\linewidth]{./figures/exp_sbi_two_moons_gt.pdf}
  %   \caption{\texttt{2-moons}: ground truth}
  %   \label{subfig:sbi_two_moons_gt}
  % \end{subfigure}
  % \begin{subfigure}[b]{.49\linewidth}
  %   \centering
  %   \includegraphics[width=\linewidth]{./figures/exp_sbi_gaussian_mixture_gt.pdf}
  %   \caption{\texttt{MoG}: ground truth}
  %   \label{subfig:sbi_gaussian_mixture_gt}
  % \end{subfigure}
...
%   \begin{subfigure}[b]{.24\linewidth}
%     \centering
%     \includegraphics[width=\linewidth]{./figures/gaussian_linear_uniform_romc.pdf}
%     \caption{\texttt{R2OMC (C2ST)}}
%     \label{subfig:sbi_linear_r2omc}
%   \end{subfigure}
%   \begin{subfigure}[b]{.24\linewidth}
%     \centering
%     \includegraphics[width=\linewidth]{./figures/gaussian_linear_uniform.pdf}
%     \caption{Rest of methods \texttt{(C2ST)}}
%     \label{subfig:sbi_linear_rest}
%   \end{subfigure}
%   \begin{subfigure}[b]{.24\linewidth}
%     \centering
%     \includegraphics[width=\linewidth]{./figures/exp_sbi_gaussian_linear_uniform_r2omc.pdf}
%     \caption{\texttt{R2OMC} samples}
%     \label{subfig:sbi_linear_r2omc_samples}
%   \end{subfigure}
%   \begin{subfigure}[b]{.24\linewidth}
%     \centering
%     \includegraphics[width=\linewidth]{./figures/exp_sbi_gaussian_linear_uniform_gt.pdf}
%     \caption{\texttt{GT} samples}
%     \label{subfig:sbi_linear_gt}
%     \end{subfigure}
%     \caption{SBI benchmark: \texttt{Gaussian Linear} experiment. In (a) we show the \CtwoST~score of \rromc~and in (b) the rest of the methods. The x-axis is the simulation budget with values in $\{10^3, 10^4, 10^5\}$. In (c) we show the samples of \rromc~and in (d) the samples of the ground truth.}
%     \label{fig:sbi_experiments_linear}
%     \end{figure*}
...
%   \begin{subfigure}[b]{.24\linewidth}
%     \centering
%     \includegraphics[width=\linewidth]{./figures/gaussian_mixture_romc.pdf}
%     \caption{\texttt{R2OMC (C2ST)}}
%     \label{subfig:sbi_gaussian_mixture_r2omc}
%   \end{subfigure}
%   \begin{subfigure}[b]{.24\linewidth}
...
%     \includegraphics[width=\linewidth]{./figures/gaussian_mixture.pdf}
%     \caption{Rest of methods \texttt{(C2ST)}}
%     \label{subfig:sbi_gaussian_mixture_rest}
%   \end{subfigure}
%   \begin{subfigure}[b]{.24\linewidth}
%     \centering
%     \includegraphics[width=\linewidth]{./figures/exp_sbi_gaussian_mixture_r2omc.pdf}
...
%     \label{subfig:sbi_gaussian_mixture_gt}
%     \end{subfigure}
%     \caption{SBI benchmark: \texttt{Gaussian Mixture} experiment. In (a) we show the \CtwoST~score of \rromc~and in (b) the rest of the methods. The x-axis is the simulation budget with values in $\{10^3, 10^4, 10^5\}$. In (c) we show the samples of \rromc~and in (d) the samples of the ground truth.}
%     \label{fig:sbi_gaussian_mixture}
% \end{figure*}
